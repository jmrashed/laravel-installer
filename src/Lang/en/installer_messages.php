...
return [
    ...
    'dependencies' => [
        ...
        'composer_dependencies' => 'Composer Dependencies',
        'critical_dependencies' => 'Critical Dependencies',
        'checking_dependencies' => 'Checking dependencies...',
        'checking_critical_dependencies' => 'Checking critical dependencies...',
        'error' => 'Error',
    ],
    'cache_queue' => [
        ...
        'optimize_application' => 'Optimize Application',
    ...
    'database_backup' => [
        ...
        'description' => 'This step will create a backup of your database before running migrations to ensure data safety.',
        'back' => 'Back',
        'next' => 'Next',
        'create_backup_label' => 'Create database backup before migration',
        'run_seeders_label' => 'Run database seeders after migration',
        'batch_size_label' => 'Migration batch size (for large databases):',
        'start_migration' => 'Start Database Migration',
