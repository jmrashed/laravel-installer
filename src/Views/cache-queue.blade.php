                ...
                <div class="content-wrapper w-full">
                    ...
                    <div class="grid gap-6 grid-cols-1 md:grid-cols-2">
                        <div class="card bg-white p-6 rounded-md space-y-4">
                            <h5 class="text-md font-semibold text-primary mb-4">{{ trans('installer_messages.cache_queue.cache_management') }}</h5>
                            <div class="space-y-3">
                                <button id="clear-cache" class="btn-primary-outline w-full">{{ trans('installer_messages.cache_queue.clear_all_caches') }}</button>
                                <button id="optimize-cache" class="btn-primary-outline w-full">{{ trans('installer_messages.cache_queue.optimize_application') }}</button>
                            </div>
                            <div id="cache-results" class="results mt-4"></div>
                        </div>

                        <div class="card bg-white p-6 rounded-md space-y-4">
                            <h5 class="text-md font-semibold text-primary mb-4">{{ trans('installer_messages.cache_queue.queue_configuration') }}</h5>
                            <form id="queue-form" class="space-y-4">
                                <div class="contact-form">
                                    <label for="queue_driver" class="text-primary block text-sm font-semibold text-gray-700">{{ trans('installer_messages.cache_queue.queue_driver') }}</label>
                                ...
                                <div id="redis-config" style="display:none;" class="space-y-4">
                                    <div class="contact-form">
                                        <label for="redis_host" class="text-primary block text-sm font-semibold text-gray-700">{{ trans('installer_messages.cache_queue.redis_host') }}</label>
                                    ...
                                    <div class="contact-form">
                                        <label for="redis_port" class="text-primary block text-sm font-semibold text-gray-700">{{ trans('installer_messages.cache_queue.redis_port') }}</label>
                                    ...
                                    <div class="contact-form">
                                        <label for="redis_password" class="text-primary block text-sm font-semibold text-gray-700">{{ trans('installer_messages.cache_queue.redis_password') }}</label>
                                ...
                                <button type="submit" class="btn-primary-fill w-full">{{ trans('installer_messages.cache_queue.setup_queue') }}</button>
                            </form>
                    ...
                    <div class="card bg-white p-6 rounded-md space-y-4 mt-6">
                        <h5 class="text-md font-semibold text-primary mb-4">{{ trans('installer_messages.cache_queue.task_scheduler') }}</h5>
                        <button id="setup-scheduler" class="btn-primary-fill">{{ trans('installer_messages.cache_queue.setup_scheduler') }}</button>
